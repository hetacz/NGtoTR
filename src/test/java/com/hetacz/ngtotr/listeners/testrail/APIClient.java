...
public class APIClient {
    ...
    @Contract(pure = true)
    public APIClient(@NotNull String base_url) {
    ...
    private static @NotNull String getAuthorization(String user, String password) {
        try {
    ...
    private Object sendRequest(@NotNull String method, String uri, Object data)
        ...
        if (method.equals("POST")) {
            ...
            if (data != null) {
                if (uri.startsWith("add_attachment")) {   // add_attachment API requests
                    ...
                    bodyWriter.write("\n\n--" + boundary + "\r\n");
                    bodyWriter.write(
                            "Content-Disposition: form-data; name=\"attachment\"; filename=\"" + uploadFile.getName() +
                                    "\"");
                    bodyWriter.write("\r\n\r\n");
                    bodyWriter.flush();
